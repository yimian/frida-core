namespace Frida {
	...
	public class LinuxHostSession : BaseDBusHostSession {
		...
		construct {
			...
			agent = new AgentDescriptor (PathTemplate ("mondarm<arch>.so"),
				new Bytes.static (blob32.data),
				new Bytes.static (blob64.data),
				new AgentResource[] {
					new AgentResource ("mondarm.so", new Bytes.static (emulated_arm.data), tempdir),
					new AgentResource ("mondarm64.so", new Bytes.static (emulated_arm64.data), tempdir),
				},
				AgentMode.INSTANCED,
				tempdir);
#endif
